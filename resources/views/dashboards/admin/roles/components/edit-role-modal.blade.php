    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        <div class="w-full max-w-lg bg-white rounded-lg shadow border border-gray-200">
            <div class="h-12 flex items-center justify-between px-4 border-b">
                ...
                <button type="button" class="text-slate-500 hover:text-slate-700" data-close="edit-role"
                    aria-label="Close">
            ...
            <form id="editRoleForm" method="POST" action="#" class="p-4 space-y-4">
                ...
                <div>
                    ...
                    <select id="edit_role_department" name="department_id" required
                ...
                <div>
                    ...
                    <textarea id="edit_role_description" name="description" rows="3"
                ...
                <div class="pt-2 flex items-center justify-end gap-3">
                    <button type="button"
                        ...
                        data-close="edit-role">Cancel</button>
                    <button type="submit"
