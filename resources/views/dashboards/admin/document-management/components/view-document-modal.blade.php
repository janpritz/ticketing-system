        ...
        <div
            ...
            <div class="p-4 space-y-4">
                ...
                <div>
                    ...
                    <pre id="view_doc_content" class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm font-mono bg-gray-50 text-gray-800 whitespace-pre-wrap overflow-auto max-h-[60vh]"></pre>
                </div>
            </div>
