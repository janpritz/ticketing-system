        ...
        <div
            ...
            <div class="h-12 flex items-center justify-between px-4 border-b">
                ...
                <div class="flex items-center gap-3">
                    <button id="deleteDocBtn" type="button"
                        class="flex items-center gap-2 text-red-600 hover:text-red-800" aria-label="Delete document">
            ...
            <form id="editDocumentForm" class="p-4 space-y-4">
                ...
                <div>
                    ...
                    <textarea id="edit_doc_content" rows="10" required
                    ...
                    <p class="mt-1 text-xs text-slate-500">Supports plain text only.</p>
