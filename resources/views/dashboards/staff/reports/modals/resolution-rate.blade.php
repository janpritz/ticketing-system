<div id="resolutionRateModal" class="fixed inset-0 z-50 overflow-y-auto hidden">
    <div class="absolute inset-0 bg-black/60 backdrop-blur-md transition-opacity"
        onclick="closeModal('resolutionRateModal')"></div>
        ...
        <div
            ...
            <div class="px-4 sm:px-6 py-4 border-b border-gray-100 flex items-center justify-between shrink-0">
                ...
                <div class="flex items-center gap-2 ml-4">
                    <button onclick="closeModal('resolutionRateModal')"
            ...
            <div class="flex-1 overflow-y-auto px-6 py-5">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="text-center">
                        <div class="text-4xl font-bold text-green-600">{{ $performanceMetrics['resolved_tickets'] }}
                        </div>
            ...
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 shrink-0">
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <button type="button" onclick="closeModal('resolutionRateModal')"
