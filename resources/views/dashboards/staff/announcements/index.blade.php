...
@section('staff-content')
    ...
    <div id="addAnnouncementModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div
                class="w-full max-w-full sm:max-w-4xl bg-white rounded-lg shadow border border-gray-200 overflow-auto h-[80vh] mx-4 sm:mx-0">
        ...
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="text-sm text-gray-700 whitespace-pre-line break-words"
                        id="viewAnnouncementContentDisplay"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        (function() {
            ...
            if ($('#pinAnnouncementMenu')) {
                $('#pinAnnouncementMenu').addEventListener('click', () => {
                    fetch('/staff/announcements/pin/' + currentAnnouncementId, {
                            method: 'POST',
                            headers: {
            ...
            async function loadAnnouncements() {
                ...
                try {
                    ...
                    const response = await fetch('/staff/announcements/list', {
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        }
                    });
