            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('staff.dashboard') }}"
                        ...
                        <svg class="w-5 h-5 {{ request()->routeIs('staff.dashboard') ? 'text-gray-900' : 'text-gray-500 group-hover:text-gray-900' }}"
                ...
                <li>
                    <a href="{{ route('staff.tickets') }}"
                        ...
                        <svg class="w-5 h-5 {{ request()->routeIs('staff.tickets') ? 'text-gray-900' : 'text-gray-500 group-hover:text-gray-900' }}"
                ...
                <li>
                    <a href="{{ route('staff.reports.index') }}"
                        ...
                        <svg class="w-5 h-5 {{ request()->routeIs('staff.reports.*') ? 'text-gray-900' : 'text-gray-500 group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                <li>
                    <button type="button"
                        ...
                        aria-controls="dropdown-faq" data-collapse-toggle="dropdown-faq">
                    ...
                    <ul id="dropdown-faq" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('staff.document_management.index') }}"
                                class="flex items-center p-2 text-sm rounded-lg hover:bg-gray-100 group {{ request()->routeIs('staff.document_management.*') ? 'bg-gray-100 text-gray-900' : 'text-gray-700' }}">
                                <svg class="w-4 h-4 {{ request()->routeIs('staff.document_management.*') ? 'text-gray-900' : 'text-gray-500 group-hover:text-gray-900' }}"
                        ...
                        <li>
                            <a href="{{ route('staff.announcements.index') }}"
                                class="flex items-center p-2 text-sm rounded-lg hover:bg-gray-100 group {{ request()->routeIs('staff.announcements.*') ? 'bg-gray-100 text-gray-900' : 'text-gray-700' }}">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-4 h-4 {{ request()->routeIs('staff.announcements.*') ? 'text-gray-900' : 'text-gray-500 group-hover:text-gray-900' }}"
                ...
                <li>
                    <a href="{{ route('staff.profile') }}"
                        ...
                        <svg class="w-5 h-5 {{ request()->routeIs('staff.profile*') ? 'text-gray-900' : 'text-gray-500 group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
