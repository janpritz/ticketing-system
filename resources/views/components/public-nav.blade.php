            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center {{ $logoMargin ?? 'mr-20' }}">
                    <a href="{{ route('faqs.index') }}" class="flex items-center">
                        ...
                        <span class="text-white font-bold text-sm tracking-wider ml-2">{{ $logoText ?? 'SANGKAY FAQs' }}</span>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    <a href="{{ route('about') }}" class="text-white text-sm font-medium hover:text-gray-100 {{ (isset($active) && $active === 'about') ? 'border-b-2 border-white' : '' }}">About Us</a>
                    <a href="{{ route('contact') }}" class="text-white text-sm font-medium hover:text-gray-100 {{ (isset($active) && $active === 'contact') ? 'border-b-2 border-white' : '' }}">Contact Us</a>
                </div>
            </div>
