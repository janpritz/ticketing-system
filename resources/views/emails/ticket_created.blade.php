                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" class="mobile-full-width"
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding:20px 24px;background:#ffffff;border-bottom:1px solid #e5e7eb;">
                            <div style="font-size:16px;font-weight:700;color:#1f2937;">Ticket Created: {{ $ticketNo }}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding:24px;">
                            ...
                            <p style="font-size:14px;color:#374151;margin:0 0 12px 0;">Your ticket has been successfully created. Below are the details:</p>
                            ...
                            <p style="font-size:14px;color:#374151;margin:0 0 12px 0;">You will receive an update via email when your ticket is received. Thank you for your patience.</p>
                        </td>
                    </tr>
