    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td style="padding:20px 24px;background:linear-gradient(90deg,#d97706,#b45309);color:#fff">
                <div style="display:flex;align-items:center;justify-content:space-between">
                    <div>
                        <h1 style="margin:0;font-size:18px;font-weight:700;letter-spacing:-0.2px">Ticket Forwarded</h1>
                        <p style="margin:4px 0 0 0;font-size:13px;opacity:0.95">Your ticket has been forwarded to another staff member.</p>
                    </div>
        ...
        <tr>
            <td class="mobile-padding" style="padding:24px;">
                ...
                <p style="margin:0 0 18px 0;color:#334155">Your ticket has been forwarded. Below are the
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    @if($forwardHistory)
                    <tr>
                        <td style="width:110px;color:#64748b;font-size:13px;vertical-align:middle">Forward History</td>
                        <td
                            style="background:#f8fafc;padding:10px 12px;border-radius:6px;color:#0f172a;border-left:3px solid #d97706">
                            {{ $forwardHistory }}</td>
                    </tr>
