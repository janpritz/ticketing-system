...
<body>
  <div class="card">
    ...
    <h2 style="margin:0 0 8px 0;">Email Verification Code</h2>
    <p class="muted" style="margin:0 0 16px 0;">Use the One-Time Password (OTP) below to verify your email for ticket creation.</p>

    <div style="margin:20px 0;">
      <span class="otp">{{ $otpCode }}</span>
    </div>

    <p class="muted" style="margin:12px 0 0 0;">This OTP expires in 15 minutes. If you did not request this verification, you can safely ignore this email.</p>
