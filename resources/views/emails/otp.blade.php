    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td style="padding:0;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="text-align:center; padding:0;">
                            ...
                            <p style="margin:4px 0 0 0; font-size:14px; color:#fef3c7; font-weight: 400;">Verify Identity to View My Tickets</p>
                        </td>
                    </tr>
                </table>

                <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                    style="width:100%; background:#ffffff; padding:32px 24px;">
                    <tr>
                        <td style="padding:0;">
                            <h2 style="margin:0 0 12px 0; font-size:18px; color:#78350f; font-weight:600;">Your Ticket
                                Viewing OTP</h2>
                            <p style="color:#92400e; font-size:14px; margin:0 0 24px 0; line-height:1.6;">
                                For your data privacy and security, we require verification before accessing your ticket
                                history. Use the One-Time Password (OTP) below to verify your identity.
                            </p>
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    Your OTP Code</p>
                                <span
                                    style="font-size:38px; letter-spacing:8px; font-weight:700; color:#451a03; display:block; word-break:break-all;">{{ $otpCode }}</span>
                            </div>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="padding:0;">
                                        <div
                                            style="background:#fffbeb; border-left:4px solid #fbbf24; padding:12px 16px; border-radius:4px; margin-bottom:12px;">
                                        ...
                                        <div
                                            style="background:#fef3c7; border-left:4px solid #ff9d00; padding:12px 16px; border-radius:4px;">
                            ...
                            <div
                                style="background:#fffdfa; border:1px solid #fde68a; border-radius:8px; padding:16px; margin:24px 0;">
                                <p style="margin:0 0 12px 0; font-size:13px; color:#78350f; font-weight:600;">How to
                                    proceed:</p>
                                <ol
                                    style="margin:0; padding-left:20px; color:#92400e; font-size:13px; line-height:1.8;">
                            ...
                            <p style="color:#b45309; font-size:12px; margin:0; line-height:1.6; text-align: center;">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                    style="width:100%; background:#451a03; border-radius:0 0 16px 16px; padding:24px;">
                    <tr>
                        <td style="text-align:center; padding:0;">
                            <p style="margin:0; font-size:12px; color:#fde68a; line-height:1.6;">
                                <strong style="color:#ffffff;">Sangkay Integrated Ticketing System &copy; 2026</strong>
                            </p>
                        </td>
                    </tr>
                </table>
