    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td style="padding:20px 24px;background:linear-gradient(90deg,#d97706,#b45309);color:#fff">
                <div style="display:flex;align-items:center;justify-content:space-between">
                    <div>
                        <h1 style="margin:0;font-size:18px;font-weight:700;letter-spacing:-0.2px">Ticket Delivered</h1>
                        <p style="margin:4px 0 0 0;font-size:13px;opacity:0.95">Your ticket has been successfully
                            submitted.</p>
                    </div>
        ...
        <tr>
            <td class="mobile-padding" style="padding:24px;">
                ...
                <p style="margin:0 0 18px 0;color:#334155">Your ticket has been delivered to our system. Below are the
