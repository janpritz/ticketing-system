                        ...
                        <div class="px-4 py-4 flex items-center justify-between hover:bg-gray-50 sm:px-6">
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $ticket->status === 'Open' ? 'bg-green-100 text-green-800' : ($ticket->status === 'In-Progress' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800') }}">
                                        {{ $ticket->status }}
                                    </span>
                                </div>
                                <div class="mt-1">
