        ...
        <div class="mt-8">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <form action="{{ route('tickets.submit') }}" method="POST" class="space-y-6" novalidate enctype="multipart/form-data">
                        @csrf
                            ...
                            document.getElementById('submitTicketBtn').addEventListener('click', function(e) {
                                ...
                                if (!category || !question) {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: 'Please fill in both category and question fields.'
                                    });
                                    return;
                                }
